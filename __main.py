...
from app.routes import webhook, send_message_template, logs, schedule_message, send_instant_message, update_token, current_token, expiration_time
...
app.include_router(send_message_template.router)
