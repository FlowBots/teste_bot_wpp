...
import requests
from fastapi.responses import PlainTextResponse  # Certifique-se de adicionar esta importação
...
async def validate_webhook(request: Request):
    ...
    print(f"Recebido: hub_mode={hub_mode}, hub_verify_token={hub_verify_token}, hub_challenge={hub_challenge}")
